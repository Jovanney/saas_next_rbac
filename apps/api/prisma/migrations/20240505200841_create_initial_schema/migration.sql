...
-- CreateEnum
CREATE TYPE "AccountProvider" AS ENUM ('GOOGLE', 'FACEBOOK', 'TWITTER', 'GITHUB');
...
CREATE TABLE "accounts" (
    ...
    "provider_accout_id" TEXT NOT NULL,
    "user_id" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "members_userId_organization_id_key" ON "members"("userId", "organization_id");
